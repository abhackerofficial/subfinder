...
try:
    ...
    sys.exit(1)
#    raise KeyError("Use setx [SD_API_KEY] \"[API_KEY]\"")

#api = "KJw82zHbwNXlprKZ0piQ1moW1QzW8iFZ"
...
{program_name} --domain [u blue]facebook.com[/] --filepath [green]fb_sd.txt[/]""")
    center_align("[b green]Program by", "ABHacker a.k.a Ankush Bhagat", width-40)
    sys.exit(1)
...
try:
    ...
    center_align(banner, "[b u yellow]https://github.com/abhackerofficial/subfinder", 55)
